...
- create [useInfoModal](/hooks/useInfoModalStore.ts)
...
- create [InfoModal](/components/InfoModal.tsx) component && [Billboard](/components/Billboard.tsx) && [MovieCard](/components/MovieCard.tsx)
...
const InfoModal = ({ visible, onClose }: InfoModalProps) => {
  ...
  useEffect(() => {
    setIsVisible(!!visible); //!! is a double negation, it converts the value to a boolean
  }, [visible]);
